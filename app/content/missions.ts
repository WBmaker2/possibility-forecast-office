...
export const missions: ForecastActivity[] = [
  {
    ...
    publicDecisionRule: { kind: "higher-known-model", text: "신호판의 칸이 더 많은 신호를 고릅니다.", options: ["blue", "green"] },
    evidenceOptions: ["파랑은 2/6, 초록은 3/6이에요."],
    explanation: "처음 나온 횟수가 같아도 신호판의 칸 수는 바뀌지 않아요.",
    misconceptionNote: "처음 나온 횟수가 같아도 신호판의 칸 수까지 같아지는 것은 아니에요.",
  },
  {
    ...
    publicDecisionRule: { kind: "forecast-only", text: "모두 합친 결과의 비율로 지금의 가능성 말을 고릅니다.", options: ["more-likely", "less-likely"] },
    evidenceOptions: ["첫 자료와 새 자료를 합친 9/20을 사용해요."],
    explanation: "새 자료 1/10만 보지 않고 모두 합친 9/20으로 예보를 다시 살펴봐요.",
    misconceptionNote: "자료가 0이나 1이 아니어도 다음 결과를 딱 정할 수 없어요.",
  },
  {
    ...
    publicDecisionRule: { kind: "higher-observed-rate", text: "같은 횟수로 시험했으니, 모두 합친 통과 비율이 더 큰 통로를 고릅니다. 같으면 자료를 더 봐요.", options: ["route-a", "route-b", "need-more-data"] },
    evidenceOptions: ["두 통로 모두 20번 자료를 비교해요."],
    explanation: "첫 선택을 고집하지 않고 모두 합친 통과 비율을 보고 바꿀 수 있어요.",
  ...
  },
  {
    ...
    publicDecisionRule: { kind: "same-rate-need-more-data", text: "나온 결과의 비율이 같으면 어느 쪽도 더 크다고 고르지 않고, 자료를 더 봐요.", options: ["sample-a-blue", "sample-b-blue", "need-more-data"] },
  ...
  },
  {
    ...
    publicDecisionRule: { kind: "known-model-next-trial", text: "다음 한 번은 신호판의 칸으로 판단합니다.", options: ["even"] },
