...
export const missions: ForecastActivity[] = [
  ...
  },
  {
    ...
    publicDecisionRule: { kind: "forecast-only", text: "지금까지 본 별 신호의 비율로 가능성 말을 고릅니다.", options: ["more-likely", "less-likely"] },
  ...
  },
  {
    ...
    publicDecisionRule: { kind: "higher-observed-rate", text: "같은 횟수로 시험했으니, 통과 비율이 더 큰 통로를 고릅니다. 같으면 자료를 더 봐요.", options: ["route-a", "route-b", "need-more-data"] },
